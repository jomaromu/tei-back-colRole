...
// Nuevo role
roleColRouter.post("/nuevoRole", [auth_1.verificaToken], (req, resp) => {
    const nuevoRole = new workerRoleClass_1.RoleColClass();
    nuevoRole.nuevoRole(req, resp);
});
// Editar role
roleColRouter.put("/editarRole", [auth_1.verificaToken], (req, resp) => {
    const editarRole = new workerRoleClass_1.RoleColClass();
    editarRole.editarRole(req, resp);
});
roleColRouter.put("/editarRestricciones", [auth_1.verificaToken], (req, resp) => {
    const editarRestricciones = new workerRoleClass_1.RoleColClass();
...
// Eliminar role
roleColRouter.delete("/eliminarRole", [auth_1.verificaToken], (req, resp) => {
